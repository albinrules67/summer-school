...
.nv>div{max-width:900px;margin:0 auto;padding:0 24px;height:100%;display:flex;align-items:center;justify-content:space-between}
...
.hri{max-width:900px;margin:0 auto;padding:0 24px;position:relative;z-index:1}
...
.st>div{max-width:900px;margin:0 auto;padding:14px 24px;display:grid;grid-template-columns:repeat(4,1fr);gap:12px;text-align:center}
...
.mn{max-width:900px;margin:0 auto;padding:32px 24px 48px}
